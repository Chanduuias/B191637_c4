...
%\definecolor{colour3}{HTML}{2ECC71}GREEN
...
\fbox{\includegraphics[scale=0.35]{suryateja.png}}
\end{figure}
...
\fbox{\includegraphics[width=7.5cm,height=5cm]{suryateja.png}}
\end{figure}
\end{minipage} \hfill
...
What else? The rook is en-prise. 20 \symking e2 \symknight a6. This covers the c7 square, as White was threatening Mate in 2, example like 20. . . h6 21 \symknight xg7+ \symking d8 22 \symbishop c7\#. 21 \symknight xg7+ \symking d8 22 \symqueen f6+!
\begin{center}
\newchessgame
\setchessboard{boardfontsize=18}
\chessboard[setfen=r1bk2nr/p2p1pNp/n2B1Q/1p1NP2P/6P/3P/P1P1K/q5b]
\end{center}
A brilliant Queen sacrifice to deflect the Knight on g8 that protects e7 22. . . \symknight xf6 23 \symbishop e7\#
\begin{center}
    \newchessgame
    \setchessboard{boardfontsize=18}
...
%chemical equations
\section*{\textbf{3 chemistry}}
\maketitle\textbf{{3.1 chemical formulae}}
...
\end{center}
\newline
\maketitle\textbf{{3.2 Molecular Orbital Diagrams}}
...
\newpage
%circuits
\section*{\textbf{4 Electrical Circuits}}
\begin{center}
...
\vspace{0.2cm}
\hspace{6.5cm}
$\sqrt{2}^2 = (\dfrac{a}{b})^2$ \hspace{10.5cm} (2)\\
\vspace{0.2cm}
\hspace{6.5cm}
2=\large{$\dfrac{a^2}{b^2}$}\vspace{0.3cm}\\
\hspace{6.5cm}  $a^2$=\Large{$2b^2$} \hspace{11cm} (3)\\
\vspace{0.2cm}
 But then from (3),we know that $a^2$ is even so that $a$ is even.But then we must have \\ \vspace{0.2cm}  \hspace{6.5cm} $ 2a^2 = b^2 $\\
\vspace{0.2cm}
